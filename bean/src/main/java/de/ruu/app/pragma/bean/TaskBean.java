...
public class TaskBean implements Task<TaskGroupBean, TaskBean>
{
    ...
    public TaskBean(String name, TaskGroupBean taskGroup)
    {
        this.name = requireNonNull(name, "name");
        requireNonNull(taskGroup, "taskGroup");
        taskGroup.addTask(this); // registers with group and sets this.taskGroup via taskGroupInternal
    }

    /** Mapping constructor — copies id, version and name from a TaskDto. */
    ...
    @Override
    public Optional<TaskGroupBean> taskGroup() { return Optional.of(taskGroup); }
